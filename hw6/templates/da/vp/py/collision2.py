...
scene = display(width=600, height=600,texture="https://s3.amazonaws.com/glowscript/textures/stucco_texture.jpg") #�e���]�w
...
b1 = sphere(radius = size,texture="https://s3.amazonaws.com/glowscript/textures/stucco_texture.jpg" ) #�e�y 1

b2 = sphere(radius = temp.z,texture="https://s3.amazonaws.com/glowscript/textures/earth_texture.jpg") #�e�y 2

#b3 = sphere(radius = size,texture="https://s3.amazonaws.com/glowscript/textures/metal_texture.jpg")

b1.pos = vector( 0, -1.8, 0) #�y 1 ���m

b2.pos = vector( random()-0.5 , random() , 0) #�y 2 ���m

#b3.pos = vector(random()*(random()*3)-0.5 , random()*(random()*3)-0.5, 0)

b1.v = vector(0, 0, 0) #�y 1 ��t

b2.v = vector(0 , 0, 0) #�y 2 ��t
